...
The supported Sync modes are:<br>
...
- Archive<br>
  Move photos and videos in the master's directory to the target if they were taken before 7 days or 30 days before the archive execution date. (However, you cannot use zip to target.)  <br>
The following file types are eligible for archiving.  <br>
gif, "jpg", "jpeg", "jpe", "png", "mp4", "mov".  <br>

**Compare criteria:** 
Files are considered different based on these criteria:<br>

1. File name exists only on master or target, not on both sides<br>
